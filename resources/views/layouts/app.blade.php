...
<body class="font-sans antialiased">
    ...
    <nav x-data="{ isOpen: false }" @keydown.escape="isOpen=false">
        ...
        <button aria-controls="default-sidebar" @click="isOpen=!isOpen" type="button"
        ...
        <aside :class="{'translate-x-0': isOpen, '-translate-x-full': ! isOpen }"
            ...
            <div class="flex flex-col h-full">
                <div class="flex justify-center w-full bg-gray-50 dark:bg-gray-800 py-4 px-2">
                    {{-- Tambahkan Logo Undiksha --}}
                    <img src="" alt="">
                    <h1 class="text-lg font-bold text-white">BKK Undiksha</h1>
                </div>
                <div class="p-8 w-full bg-indigo-500 flex flex-col items-center justify-center">
                    <div class="w-32 h-32 bg-red-500"></div>
                    <p class="text-white text-xl font-semibold text-center">Sistem Kendali<br>Program Aktifitas</p>
                </div>
                    ...
                    <ul class="flex flex-col font-medium h-full">
                        ...
                        <li>
                            <a href="#" @click="isOpen=false"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Input Program</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" @click="isOpen=false"
